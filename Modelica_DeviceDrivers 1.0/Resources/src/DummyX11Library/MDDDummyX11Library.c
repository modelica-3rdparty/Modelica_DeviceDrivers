 ...
 * @version	$Id: MDDDummyX11Library.c 5522 2012-09-20 22:39:25Z thiele $
 * @since		2012-05-25
 ...
 *
 * - <B>The problem</B>: We need to specify in Modelica to link against the X11 library if running on Linux, but
