...
<body lang=\"en-US\">
    <p>All files in this directory (&ldquo;Modelica_DeviceDrivers&rdquo;) and
    in all subdirectories are licensed by <strong>DLR</strong> under the
    &ldquo;Modelica License&nbsp;2&rdquo; (with exception of the contents of
    the directories &ldquo;Modelica_DeviceDrivers/Resources/Library&rdquo; and
    &ldquo;Modelica_DeviceDrivers/Resources/thirdParty&rdquo;).</p>
