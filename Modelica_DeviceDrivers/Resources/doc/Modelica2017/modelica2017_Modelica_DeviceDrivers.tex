...
\mbox{\clang{#endif}}, \textit{etc.}) similarly to the code fragment below.
...
in any Modelica tool since all the OS support, real-time code, \textit{etc.} is
abstracted away.
...
no OS or I/O functions, no threading models, \textit{etc.}),
