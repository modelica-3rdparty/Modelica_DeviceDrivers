...
environement, the \emph{Modelica\_DeviceDrivers} (MDD) library uses a different approach.
...
which caused unintentional incompatibilties with other Modelica tools.
...
of suitably efficient, minimal C code without use of OS functionality such as file
support \footnote{The code was tested with OpenModelica,
which has an option to generate minimal code that only simulates a model.}.
