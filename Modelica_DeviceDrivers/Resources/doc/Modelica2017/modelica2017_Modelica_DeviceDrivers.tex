...
With the help of Modelica\_DeviceDrivers serial port implementation, the Arduino can be utilized to make sensor data available in a real-time Modelica model.
