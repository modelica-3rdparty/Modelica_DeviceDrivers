...
block allows to pack unsigned integer values on the bit level. The number of bits used
for encoding is set by a parameter \modelica{width}, therefore the maximum value
