...
development environments, like the tool chain provided for the dSPACE SCALEXIO\cref{dspace} platform.
...
The type \modelica{Real} either can be packed as double-precision or (using a C static cast) as single-precision floating-point number.
\begin{figure}[h]
  \centering
