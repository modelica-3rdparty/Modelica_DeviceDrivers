...
models (see \cref{ModelicaDeviceDrivers}).
...
\cref{sec:CrossPlatformSupport}).

The library is organized in several layers as indicated in
\cref{fig:MDDLayeredArchitecture}. Notice that the library
...
\cref{fig:MDDLayeredArchitecture}). These Modelica functions provide a
...
This is discussed in more detail in \cref{sec:ModelicaStandardCompliance}.
