...
extending the number of Modelica tools which support MDD (Section~\ref{sec:SerialPackager}).
...
The SocketCAN and the Comedi blocks use a Modelica record as means
