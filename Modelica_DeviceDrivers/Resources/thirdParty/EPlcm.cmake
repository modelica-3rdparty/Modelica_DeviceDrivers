...
if (UNIX)
  ...
  elseif ( CMAKE_SIZEOF_VOID_P EQUAL 4 )
    ExternalProject_Add(EPlcm
      ...
      URL https://github.com/lcm-proj/lcm/releases/download/v1.3.1/lcm-1.3.1.zip
      CONFIGURE_COMMAND <SOURCE_DIR>/configure --prefix=${CMAKE_CURRENT_SOURCE_DIR}/lcm --without-python --without-java --enable-static --build=i686-pc-linux-gnu "CFLAGS=-m32" "CXXFLAGS=-m32" "LDFLAGS=-m32" "PKG_CONFIG_PATH=${dirGlibLib}/pkgconfig"
      BUILD_COMMAND make
    )
    add_dependencies(EPlcm EPglib)
    ExternalProject_Get_Property(EPlcm install_dir)
