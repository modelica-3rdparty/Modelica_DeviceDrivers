...
Note that additional to this library it is still necessary to install the linux drivers for the space mouse (also available from from http://www.3dconnexion.com/) to use the Modelica space mouse block.
